    ...
    >
      ...
      <UserFollowedStreams>
        ...
        <FlatList
          ...
          getItemLayout={(_, index) => ({ length: 276, offset: 276 * index, index })}
      ...
      <TopGames>
        ...
        <FlatList
          data={
            !isLoadingTopGames
              ? topGames
              : [{ id: '1' } as TopGames, { id: '2' } as TopGames, { id: '3' } as TopGames]
          }
          keyExtractor={(item) => item.id}
          horizontal
          showsHorizontalScrollIndicator={false}
      ...
      <Modal animationType="fade" visible={isLoggingOut} statusBarTranslucent transparent>
